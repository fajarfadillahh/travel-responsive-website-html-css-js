...
sr.reveal(
  `.home__data, .home__social-link, .home__info, .discover__container, .experience__data, .experience__img, .place__card, .sponsor__content, .footer__data, .footer__rights`,
  {
    origin: "top",
    interval: 100,
  }
...
sr.reveal(`.about__data, .video__text, .subscribe__text`, {
  origin: "left",
});
